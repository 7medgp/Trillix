            ...
            <div class="side-bar" style="width:15%; position:relative; left:20px;">
                ...
                <form aciton="shop.php" id="check" method="get">
                    ...
                    <fieldset style="margin: 10px;">
                        ...
                        <label style="display: block;"><input type="radio" name="tri" value="ASC" form="check"  id="cat">lowest price</label>
                        <label style="display: block;"><input type="radio" name="tri" value="DESC" form="check"  id="cat">highest price</label>
                    </fieldset>
            ...
            <div class="shop-container container">
                <?php
                    ...
                    if($_SERVER["REQUEST_METHOD"]=="POST"){
                        ...
                        $req_prod="SELECT label, prix, urltsawer from produits $condition $sort;";
